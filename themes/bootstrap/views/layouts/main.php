...
<head>
	...
	<!-- 04may2017 -->
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/overwrite.css"/>
...
<script type="text/javascript"> 
	...
	{
		$("#btnApproveInbox, #btnRejectInbox,#btnApproveKbbInbox, a[title=approve]").on('click', function()
		{
