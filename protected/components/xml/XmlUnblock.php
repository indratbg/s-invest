...
class XmlUnblock extends Xml
{
	 ...
	 */
	public static function generateXmlUnblock($arr,$save_dt)
	{
		$model = new SDIUnblock();
		$write001 = false;
		$write004 = false;
		
		$filename001 = XmlUnblock::changeDateFormat($save_dt).'unblock1.sdiap';
		$filename004 = XmlUnblock::changeDateFormat($save_dt).'unblock4.sdiap';
		...
		foreach($arr as $object)
		{
			...
			if($model->yn_001):
				...
				$content001 .= "<Field name=\"actionTobeApprove\">UNBLOCK</Field>\r\n";
			...
			if($model->yn_004):
				...
				$content004 .= "<Field name=\"actionTobeApprove\">UNBLOCK</Field>\r\n";
