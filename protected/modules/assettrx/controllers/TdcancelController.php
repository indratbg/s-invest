...
class TdcancelController extends AAdminController
{
    ...
    public function actionIndex()
    {
        ...
        {
            $model->attributes = $_POST['Tdcancel'];
            ...
            if ($scenario == 'retrieve')
            {
                ...
                $modelDetail = Tdcancel::model()->findAllBySql($model->getListData($model->trx_date, $stk_cd, $client_cd, $im_code));
            }
            else if ($scenario == 'cancel')
            {
                ...
                {
                    $modelDetail[$x] = new Tdcancel;
                    $modelDetail[$x]->attributes = $_POST['Tdcancel'][$x];
