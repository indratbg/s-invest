...
$this->breadcrumbs = array(
    'Trade Detail Cancel'=> array('index'),
    'List',
);
$this->menu = array(
    array(
        'label'=>'Trade Detail Cancel',
...
<table id="tableCancel" class="table-bordered table-condensed" style="width: 90%">
    ...
    <tbody>
        ...
        <tr id="row<?php echo $x ?>" >
           <td>
               <?php echo $form->textField($row,'client_cd',array('name'=>'Tdcancel['.$x.'][client_cd]','class'=>'span','readonly'=>'readonly')) ;?>
                <?php echo $form->textField($row,'trx_seq_no',array('name'=>'Tdcancel['.$x.'][trx_seq_no]','style'=>'display:none'));?>    
           </td>
           <td><?php echo $form->textField($row,'stk_cd',array('name'=>'Tdcancel['.$x.'][stk_cd]','class'=>'span','readonly'=>'readonly')) ;?></td>
           <td><?php echo $form->textField($row,'beli_jual',array('name'=>'Tdcancel['.$x.'][beli_jual]','class'=>'span','readonly'=>'readonly')) ;?></td>
           <td><?php echo $form->textField($row,'trx_desc',array('name'=>'Tdcancel['.$x.'][trx_desc]','class'=>'span','readonly'=>'readonly')) ;?></td>
           <td><?php echo $form->textField($row,'price',array('name'=>'Tdcancel['.$x.'][price]','class'=>'span tnumberdec','readonly'=>'readonly','style'=>'text-align:right')) ;?></td>
            <td><?php echo $form->textField($row,'qty',array('name'=>'Tdcancel['.$x.'][qty]','class'=>'span tnumber','readonly'=>'readonly','style'=>'text-align:right')) ;?> </td>
             <td><?php echo $form->textField($row,'curr_value',array('name'=>'Tdcancel['.$x.'][curr_value]','class'=>'span tnumber','readonly'=>'readonly','style'=>'text-align:right')) ;?> </td>
            <td><?php echo $form->checkBox($model,'save_flg',array('name'=>'Tdcancel['.$x.'][save_flg]','value'=>'Y'));?></td>
        </tr>
...
<script>
    ...
    {
        var result = [];
        $('#Tdcancel_client_cd').autocomplete(
        {
            source: function (request, response) 
            {
                $.ajax({
                    ...
                    'data'      :   {
                                        'term': request.term,
                                        'trx_date':$('#Tdcancel_trx_date').val()
                                    },
