...
$this->breadcrumbs = array(
    'Fixed Income Trade Confirmation Cancel'=> array('index'),
    'List',
);
$this->menu = array(
    array(
        'label'=>'Fixed Income Trade Confirmation Cancel',
...
<table id="tableCancel" class="table-bordered table-condensed" style="width: 50%">
    ...
    <tbody>
        ...
        <tr id="row<?php echo $x ?>" >
           <td>
               <?php echo $form->textField($row,'im_code',array('name'=>'Fitccancel['.$x.'][im_code]','class'=>'span','readonly'=>'readonly')) ;?>
               <?php echo $form->textField($row,'trx_seq_no',array('name'=>'Fitccancel['.$x.'][trx_seq_no]','style'=>'display:none')) ;?>
           </td>
           <td><?php echo $form->textField($row,'security_code',array('name'=>'Fitccancel['.$x.'][security_code]','class'=>'span','readonly'=>'readonly')) ;?></td>
           <td><?php echo $form->textField($row,'buy_sell',array('name'=>'Fitccancel['.$x.'][buy_sell]','class'=>'span','readonly'=>'readonly')) ;?></td>
           <td><?php echo $form->textField($row,'price',array('name'=>'Fitccancel['.$x.'][price]','class'=>'span tnumberdec','readonly'=>'readonly','style'=>'text-align:right')) ;?></td>
            <td><?php echo $form->textField($row,'face_value',array('name'=>'Fitccancel['.$x.'][face_value]','class'=>'span tnumber','readonly'=>'readonly','style'=>'text-align:right')) ;?> </td>
            <td><?php echo $form->checkBox($model,'save_flg',array('name'=>'Fitccancel['.$x.'][save_flg]','value'=>'Y'));?></td>
        </tr>
