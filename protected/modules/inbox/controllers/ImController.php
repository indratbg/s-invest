...
class ImController extends AAdminController
{
    ...
    public function actionView($id)
    {
        ...
        if($model->status == AConstant::INBOX_STAT_UPD){
            $modelDetail     = Im::model()->find("rowid ='$model->table_rowid'");  // left
            $modelDetailUpd  = Im::model()->find("rowid ='$model->table_rowid'");  // right [updated version]
            ...
            if($model->status == AConstant::INBOX_STAT_CAN){
                $modelDetail     = Im::model()->find("rowid ='$model->table_rowid'");  
            }else{
                $modelDetail  = new Im();
