...
{
    public $table_name = 'MST_FUND_CLIENT';
    ...
    public function actionView($id)
    {
        ...
        if($model->status == AConstant::INBOX_STAT_UPD){
            $modelDetail     = Fundclient::model()->find("rowid ='$model->table_rowid'");  // left
            $modelDetailUpd  = Fundclient::model()->find("rowid ='$model->table_rowid'");  // right [updated version]
            ...
            if($model->status == AConstant::INBOX_STAT_CAN){
                $modelDetail     = Fundclient::model()->find("rowid ='$model->table_rowid'");  
            }else{
                $modelDetail  = new Fundclient();
