...
{
    public $table_name = 'MST_FUND_COUNTERPART';
    ...
    public function actionView($id)
    {
        ...
        if($model->status == AConstant::INBOX_STAT_UPD){
            $modelDetail     = Fundcounterpart::model()->find("rowid ='$model->table_rowid'");  // left
            $modelDetailUpd  = Fundcounterpart::model()->find("rowid ='$model->table_rowid'");  // right [updated version]
            ...
            if($model->status == AConstant::INBOX_STAT_CAN){
                $modelDetail     = Fundcounterpart::model()->find("rowid ='$model->table_rowid'");  
            }else{
                $modelDetail  = new Fundcounterpart();
