<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model,'trx_type',array('R'=>'Setoran','W'=>'Tarik','B'=>'Bunga'),array('prompt'=>'All'));?>
	<?php echo $form->textFieldRow($model,'client_cd',array('class'=>'span5','maxlength'=>15)); ?>
	<?php echo $form->textFieldRow($model,'trx_amt',array('class'=>'span5','maxlength'=>15)); ?>
