...
FROM ALL_TAB_COLUMNS A, ALL_OBJECTS B, USER_COL_COMMENTS COM
...
WHERE B.OWNER = A.OWNER
	...
	and (A.table_name = COM.table_name(+) AND A.column_name = COM.column_name(+))
