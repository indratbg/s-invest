...
EOD;
	...
	public static function errorSummary($model,$header=null,$footer=null,$htmlOptions=array())
	{
		...
		{
			if($header===null)
				$header='<p>'.Yii::t('yii','The following error occurs:').'</p>';
			if(!isset($htmlOptions['class']))
	...
	public static function listOptions($selection,$listData,&$htmlOptions)
	{
		...
		/*--------edited--------*/
		if(isset($htmlOptions['percent']))
		{
			$content.='<option value="%">'.strtr($htmlOptions['percent'],array('<'=>'&lt;', '>'=>'&gt;'))."</option>\n";
			unset($htmlOptions['percent']);
		}
		/*--------edited--------*/
